...
import { NewsEventRowComponent } from './event-row/news-event-row/news-event-row.component';
import { TransactionEventRowComponent } from './event-row/transaction-event-row/transaction-event-row.component';
import { AppRoutingModule } from './app-routing.module';
import { EventViewComponent } from './event-view/event-view.component';
import { NewsEventViewComponent } from './event-view/news-event-view/news-event-view.component';
import { TransactionEventViewComponent } from './event-view/transaction-event-view/transaction-event-view.component';
